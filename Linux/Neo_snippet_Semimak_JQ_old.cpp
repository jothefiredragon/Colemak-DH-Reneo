...
xkb_symbols "neo_base" {
    ...
    key <AD01> { [ f,                       F,                       ellipsis,                Greek_phi,               Prior,                   Prior,                   Greek_PHI,               NoSymbol                 ] };
    key <AD02> { [ l,                       L,                       U2113,                   Greek_lambda,            BackSpace,               BackSpace,               Greek_LAMBDA,            NoSymbol                 ] };
    key <AD03> { [ h,                       H,                       braceleft,               Greek_psi,               Up,                      Up,                      Greek_PSI,               NoSymbol                 ] };
    key <AD04> { [ v,                       V,                       braceright,              U205E,                   Delete,                  Delete,                  U2234,                   NoSymbol                 ] };
    key <AD05> { [ z,                       Z,                       plus,                    Greek_zeta,              Next,                    Next,                    U2124,                   NoSymbol                 ] };
   
    key.type[Group1] = "EIGHT_LEVEL_LEVEL_FIVE_LOCK";
    key <AD06> { [ apostrophe,              quotedbl,                bar,                     U03F5,                   dead_doubleacute,        NoSymbol,                intersection,            NoSymbol                 ] };
    key.type[Group1] = "EIGHT_LEVEL_ALPHABETIC_LEVEL_FIVE_LOCK";
    key <AD07> { [ w,                       W,                       U300C,                   Greek_omega,             KP_7,                    U2466,                   Greek_OMEGA,             NoSymbol                 ] };
    key <AD08> { [ u,                       U,                       U300D,                   U205C,                   KP_8,                    U2467,                   includedin,              NoSymbol                 ] };
    key <AD09> { [ o,                       O,                       U232C,                   Greek_omicron,           KP_9,                    U2468,                   elementof,               NoSymbol                 ] };
    key <AD10> { [ y,                       Y,                       asciitilde,              Greek_upsilon,           KP_Add,                  KP_Add,                  nabla,                   NoSymbol                 ] };
    key.type[Group1] = "EIGHT_LEVEL_LEVEL_FIVE_LOCK";
    key <AD11> { [ minus,                   underscore,              division,                Greek_finalsmallsigma,   U221E,                   NoSymbol,                jot,                     NoSymbol                 ] };
    key <AD12> { [ dead_acute,              dead_tilde,              multiply,                dead_psili,              variation,               NoSymbol,                dead_breve,              NoSymbol                 ] };

    // Middle row
    // --------------------------------------------------------------
    key.type[Group1] = "EIGHT_LEVEL_ALPHABETIC_LEVEL_FIVE_LOCK";
    key <AC01> { [ s,                       S,                       ampersand,               Greek_sigma,             Home,                    Home,                    Greek_SIGMA,             NoSymbol                 ] };
    key <AC02> { [ r,                       R,                       asterisk,                Greek_rho,               Left,                    Left,                    U211D,                   NoSymbol                 ] };
    key <AC03> { [ n,                       N,                       bracketleft,             Greek_nu,                Down,                    Down,                    U2115,                   NoSymbol                 ] };
    key <AC04> { [ t,                       T,                       bracketright,            Greek_tau,               Right,                   Right,                   partialderivative,       NoSymbol                 ] };
    key <AC05> { [ k,                       K,                       equal,                   Greek_kappa,             End,                     End,                     U2235,                   NoSymbol                 ] };

    key <AC06> { [ c,                       C,                       backslash,               Greek_chi,               dead_diaeresis,          NoSymbol,                U2102,                   NoSymbol                 ] };
    key <AC07> { [ d,                       D,                       parenleft,               Greek_delta,             KP_4,                    U2463,                   Greek_DELTA,             NoSymbol                 ] };
    ...
    key <AC10> { [ i,                       I,                       at,                      Greek_iota,              KP_0,                    U24EA,                   integral,                NoSymbol                 ] };
    key.type[Group1] = "EIGHT_LEVEL_LEVEL_FIVE_LOCK";
    ...
    key <AB02> { [ j,                       J,                       U221B,                   Greek_theta,             Tab,                     Tab,                     Greek_THETA,             NoSymbol                 ] };
    key <AB03> { [ b,                       B,                       radical,                 Greek_beta,              Insert,                  Insert,                  Greek_GAMMA,             NoSymbol                 ] };
    key <AB04> { [ m,                       M,                       U2133,                   Greek_mu,                Return,                  Return,                  U204A,                   NoSymbol                 ] };
    key <AB05> { [ q,                       Q,                       grave,                   U03D5,                   Undo,                    Redo,                    U211A,                   NoSymbol                 ] };

    key <AB06> { [ p,                       P,                       Greek_pi,                U205B,                   dead_abovering,          U2051,                   Greek_PI,                NoSymbol                 ] };
    key <AB07> { [ g,                       G,                       U210A,                   Greek_gamma,             KP_1,                    U2460,                   leftarrow,               NoSymbol                 ] };
    key.type[Group1] = "EIGHT_LEVEL_LEVEL_FIVE_LOCK";
